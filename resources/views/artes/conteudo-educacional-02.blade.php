  ...
  <div class="banner-wrap" id="banner-wrap">
    <div class="banner">
      ...
      <div class="content">
        ...
        <h1 class="title" contenteditable="true" data-default="Transformando impostos em impacto social">Transformando impostos em impacto social</h1>
        <p class="description" contenteditable="true" data-default="IRPFM: descubra como planejamento tributário e investimento consciente podem gerar valor para você e para a sociedade.">IRPFM: descubra como planejamento tributário e investimento consciente podem gerar valor para você e para a sociedade.</p>
      </div>
      <div class="footer">
    ...
    (function () {
      ...
      btn.addEventListener('click', function () {
        ...
        html2canvas(wrap, {
          ...
          link.download = 'conteudo-educacional-02-' + w + 'x' + h + '.png';
