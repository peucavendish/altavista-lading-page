...
<head>
  ...
  <title>Alta Vista – Balanço mensal (arte institucional)</title>
  <style>
    @font-face {
...
<body>
  <div class="export-panel">
    ...
    <p class="hint">Textos editáveis no banner. Tamanho nativo 1200 × 630 (Open Graph / links).</p>
    <div class="row">
  ...
  <div class="banner-wrap" id="banner-wrap">
    <div class="banner">
      ...
      <div class="inner">
        ...
        <span class="badge" contenteditable="true" data-default="Relatório mensal">Relatório mensal</span>
        <h1 class="title" contenteditable="true" data-default-html='Balanço <span class="accent">mensal</span>'>Balanço <span class="accent">mensal</span></h1>
        <p class="subtitle" contenteditable="true" data-default="Panorama do período · Alta Vista Investimentos">Panorama do período · Alta Vista Investimentos</p>
        <img
          class="logo"
    ...
    (function () {
      ...
      btn.addEventListener('click', function () {
        ...
        html2canvas(wrap, {
          ...
          link.download = 'balanco-mensal-01-' + w + 'x' + h + '.png';
