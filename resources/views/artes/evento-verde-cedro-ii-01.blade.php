...
<head>
  ...
  <title>Alta Vista – Live Verde Cedro II 790x1080</title>
  <style>
    @font-face {
...
<body>
  ...
  <div class="banner-wrap" id="banner-wrap">
    <div class="banner">
      ...
      <div class="content">
        <p class="label" contenteditable="true" data-default="AO VIVO">AO VIVO</p>
        <h1 class="title" contenteditable="true" data-default="Live sobre o Fundo Verde Cedro II">Live sobre o Fundo Verde Cedro II</h1>
        <p class="description" contenteditable="true" data-default="Gestor Luiz Parreiras ao vivo: cenário, principais pontos do fundo e espaço para dúvidas. CDI + 2,30% (livre de impostos).">Gestor Luiz Parreiras ao vivo: cenário, principais pontos do fundo e espaço para dúvidas. CDI + 2,30% (livre de impostos).</p>
      </div>
      <div class="footer">
    ...
    (function () {
      ...
      btn.addEventListener('click', function () {
        ...
        html2canvas(wrap, {
          ...
          link.download = 'evento-verde-cedro-ii-01-' + w + 'x' + h + '.png';
