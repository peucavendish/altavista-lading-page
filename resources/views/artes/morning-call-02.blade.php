...
<head>
  ...
  <title>Alta Vista – Morning Call thumbnail 2</title>
  <style>
    @font-face {
...
<body>
  ...
  <div class="banner">
    ...
    <div class="title-block">
      ...
      <p class="subtitle" contenteditable="true" data-default="Análise diária de mercados">Análise diária de mercados</p>
    </div>
  </div>
  </div>
    ...
    (function () {
      ...
      btn.addEventListener('click', function () {
        ...
        html2canvas(wrap, {
          ...
          link.download = 'morning-call-02-' + w + 'x' + h + '.png';
