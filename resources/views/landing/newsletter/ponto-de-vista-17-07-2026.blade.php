...
<head>
  ...
  <title>Ponto de Vista - Semana de 13 a 17 de julho de 2026</title>
  <meta name="description" content="Ponto de Vista: a leitura da Alta Vista sobre os mercados, por Guilherme Jung, economista-chefe. Semana de 13 a 17 de julho de 2026.">
  <meta property="og:type" content="article">
  <meta property="og:locale" content="pt_BR">
  <meta property="og:title" content="Ponto de Vista - Semana de 13 a 17 de julho de 2026">
  ...
  <meta name="twitter:title" content="Ponto de Vista - Semana de 13 a 17 de julho de 2026">
          ...
          <table role="presentation" class="newsletter-card" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px; width:100%; background-color:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 10px 30px rgba(10,22,40,0.10);">
                  ...
                  <tr>
                    <td align="center" class="pad-page" style="padding:8px 30px 0 30px; text-align:center;">
                      ...
                      <p style="margin:2px 0 0 0; font-size:13px; line-height:1.7; color:#f7fafc; font-family:Arial, sans-serif; text-align:center;">
                        <strong>Semana de 13 a 17 de julho de 2026</strong>
                      </p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <p style="margin:0; font-size:13px; line-height:1.65; color:#edf2f7; font-family:Arial, sans-serif;">
                        Inflação americana surpreendeu para baixo em junho — CPI e PPI caíram, puxados pelo recuo de energia durante o cessar-fogo no Oriente Médio. O alívio durou pouco: o conflito voltou a escalar e o petróleo já bate perto de US$ 90/barril.
                      </p>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:4px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  CPI dos EUA recuou 0,4% em junho, levando a inflação em 12 meses de 4,2% para 3,5%. Fed reduziu ainda mais a chance de alta de juros em 2026, mas Powell foi claro: alívio não é &ldquo;missão cumprida&rdquo;.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  China decepcionou — PIB cresceu 4,3% no 2º tri, pior ritmo desde 2022, com consumo ainda travado pela crise imobiliária.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Atividade de maio veio mista: varejo e serviços recuaram, IBC-Br surpreendeu positivamente. PIB 2026 segue projetado em 2,0%.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Tarifa extra de 25% dos EUA sobre produtos brasileiros entra em vigor dia 22/07 — mas com petróleo, café, carne e aeronaves de fora, impacto macro deve ser limitado.
                </p>
              </td>
            </tr>
                  ...
                  <tr>
                    <td style="padding:16px 18px;">
                      <p style="margin:0 0 10px 0; font-size:15px; font-weight:bold; color:#0a1628; font-family:Arial, sans-serif;">
                        📈 Mercados — Fechamento semanal (17/07/2026)
                      </p>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#c53030; font-family:Arial, sans-serif;">−2,33% a 173.714 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#c53030; font-family:Arial, sans-serif;">+0,18% a R$ 5,11</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#c53030; font-family:Arial, sans-serif;">−1,55% a 7.458 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#276749; font-family:Arial, sans-serif;">+0,11% a 3.847 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Mercados são cíclicos por natureza. Inflação aliviando e petróleo subindo ao mesmo tempo é um lembrete: dado de curto prazo raramente conta a história toda.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#0a1628; border-radius:14px;">
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>BCE decide juros</strong> — expectativa de manutenção</td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>China decide juros</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>PMIs de julho</strong> — EUA e Zona do Euro</td></tr>
                        <tr><td style="padding:2px 0 8px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Congresso em recesso</strong> — radar doméstico mais leve</td></tr>
                      </table>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 10px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Interpretar o cenário e transformar informação em estratégia faz toda a diferença. Na Alta Vista, acompanhamos o mercado diariamente para ajudar você a construir e preservar patrimônio.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
