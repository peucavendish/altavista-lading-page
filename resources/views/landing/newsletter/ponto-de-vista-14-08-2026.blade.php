...
<head>
  ...
  <title>Ponto de Vista - Semana de 10 a 14 de agosto de 2026</title>
  <meta name="description" content="Ponto de Vista: a leitura da Alta Vista sobre os mercados, por Guilherme Jung, economista-chefe. Semana de 10 a 14 de agosto de 2026.">
  <meta property="og:type" content="article">
  <meta property="og:locale" content="pt_BR">
  <meta property="og:title" content="Ponto de Vista - Semana de 10 a 14 de agosto de 2026">
  ...
  <meta name="twitter:title" content="Ponto de Vista - Semana de 10 a 14 de agosto de 2026">
          ...
          <table role="presentation" class="newsletter-card" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px; width:100%; background-color:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 10px 30px rgba(10,22,40,0.10);">
                  ...
                  <tr>
                    <td align="center" class="pad-page" style="padding:8px 30px 0 30px; text-align:center;">
                      ...
                      <p style="margin:2px 0 0 0; font-size:13px; line-height:1.7; color:#f7fafc; font-family:Arial, sans-serif; text-align:center;">
                        <strong>Semana de 10 a 14 de agosto de 2026</strong>
                      </p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <p style="margin:0; font-size:13px; line-height:1.65; color:#edf2f7; font-family:Arial, sans-serif;">
                        Inflação americana comportada, mas geopolítica tensa: essa foi a combinação que moveu os mercados. CPI e PPI de julho vieram em linha/abaixo do esperado nos EUA, elevando para cerca de 60% a chance de o Fed manter juros em setembro. Enquanto isso, o Brent oscilou com as incertezas sobre o Estreito de Ormuz, fechando perto de US$ 88. No Brasil, o humor foi outro: IPCA acima do esperado e forte saída de capital estrangeiro pesaram sobre os ativos locais.
                      </p>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:4px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Nos Estados Unidos, o CPI de julho (+0,1% no mês, 3,4% em 12 meses) e o PPI estável reforçaram a leitura de inflação sob controle, mesmo com o núcleo ainda acima da meta.
                </p>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Isso tem dois efeitos claros: o mercado reduz a aposta em alta de juros no curto prazo, e o S&amp;P 500 rompe os 7.800 pontos, em terceira semana seguida de ganhos.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Na frente corporativa, CoreWeave e Super Micro dispararam 19% após resultados fortes, validando o ciclo de investimento em IA. A Nvidia anunciou parceria com seis gestoras para mobilizar US$ 500 bi em infraestrutura de IA. Enquanto isso, na Ásia, o Nikkei liderou os ganhos globais (+3,5% em dólar na semana), enquanto a China (−3,5%) seguiu pressionada.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  No Brasil, a semana trouxe o IPCA de julho (+0,07%), que veio acima do esperado e interrompeu a sequência de surpresas baixistas — ainda que concentrado em itens voláteis.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  O resultado abriu a ponta longa da curva de juros (DI jan/36: +27 p.b.) e, somado à revisão negativa de um banco estrangeiro sobre ativos locais, provocou saída líquida de R$ 8 bi da bolsa na semana (R$ 45,2 bi desde abril). O dólar subiu 2,7%, voltando a R$ 5,22.
                </p>
              </td>
            </tr>
                  ...
                  <tr>
                    <td style="padding:16px 18px;">
                      <p style="margin:0 0 10px 0; font-size:15px; font-weight:bold; color:#0a1628; font-family:Arial, sans-serif;">
                        📈 Mercados — Fechamento semanal (14/08/2026)
                      </p>
                      <p style="margin:0 0 12px 0; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">
                        Os mercados reagiram com cautela ao ambiente global mais incerto. Destaque corporativo: Embraer (+6,8%) puxou as altas; Hapvida (−37,4%) liderou as quedas após piora na sinistralidade.
                      </p>
                      <p style="margin:0 0 12px 0; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#c53030; font-family:Arial, sans-serif;">−3,2% a 166.934 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#276749; font-family:Arial, sans-serif;">+0,3% a 7.799 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#c53030; font-family:Arial, sans-serif;">+2,7% a R$ 5,22</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                <td class="mercado-ind-label" valign="middle" style="padding:12px 14px 12px 16px; font-size:12px; line-height:1.35; color:#718096; font-family:Arial, sans-serif; width:42%;">Curva de juros (DI jan/36)</td>
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#c53030; font-family:Arial, sans-serif;">+27 p.b., a 14,68%</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Mercados são cíclicos por natureza. A bolsa brasileira acumula nove pregões de queda em meio a fluxo estrangeiro negativo e inflação ainda resistente — mas os fundamentos de lucro seguem em recuperação, com temporada de resultados fraca, porém não catastrófica. Lá fora, o ciclo de IA segue validado por dados concretos de receita e margem, não apenas expectativa.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Ciclos mudam. Políticas mudam. E os mercados se ajustam. Disciplina e diversificação continuam sendo a resposta mais robusta à volatilidade de curto prazo.
                </p>
              </td>
            </tr>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#0a1628; border-radius:14px;">
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Ata do FOMC (quarta) e PMIs preliminares (sexta) nos EUA</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Dados de atividade da China (varejo, produção industrial)</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>No Brasil: IBC-Br (jun) e IGP-10 (ago)</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Resultados de Alibaba, Walmart, Home Depot e Lowe&rsquo;s</strong></td></tr>
                        <tr><td style="padding:2px 0 8px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">Juros e câmbio seguem no radar como termômetro do apetite por risco global.</td></tr>
                      </table>
                    </td>
                  </tr>
                </table>
