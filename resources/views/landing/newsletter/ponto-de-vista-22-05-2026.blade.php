...
<head>
  ...
  <title>Ponto de Vista - Semana de 19 a 22 de maio de 2026</title>
  <meta name="description" content="Ponto de Vista: a leitura da Alta Vista sobre os mercados, por Guilherme Jung, economista-chefe. Semana de 19 a 22 de maio de 2026.">
  <meta property="og:type" content="article">
  <meta property="og:locale" content="pt_BR">
  <meta property="og:title" content="Ponto de Vista - Semana de 19 a 22 de maio de 2026">
  ...
  <meta name="twitter:title" content="Ponto de Vista - Semana de 19 a 22 de maio de 2026">
          ...
          <table role="presentation" class="newsletter-card" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px; width:100%; background-color:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 10px 30px rgba(10,22,40,0.10);">
                  ...
                  <tr>
                    <td align="center" class="pad-page" style="padding:8px 30px 0 30px; text-align:center;">
                      ...
                      <p style="margin:2px 0 0 0; font-size:13px; line-height:1.7; color:#f7fafc; font-family:Arial, sans-serif; text-align:center;">
                        <strong>Semana de 19 a 22 de maio de 2026</strong>
                      </p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <p style="margin:0; font-size:13px; line-height:1.65; color:#edf2f7; font-family:Arial, sans-serif;">
                        Esse cenário reacende o debate sobre juros mais altos por mais tempo. A ata do Fed divulgada nesta semana mostrou um comitê inclinado ao aperto: a maioria dos membros sinalizou que novos aumentos podem ser necessários caso a inflação não recue. Com o CPI americano de abril em <strong>3,8%</strong> e o PPI em <strong>6,0%</strong> — ambos acima das expectativas — o mercado já precifica probabilidade superior a <strong>80%</strong> de alta de juros nos EUA até o fim do ano.
                      </p>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:4px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Nos Estados Unidos, a combinação de inflação acima da meta e atividade resiliente reforçou a postura restritiva do Fed — e a semana trouxe uma virada histórica na instituição: <strong>Kevin Warsh</strong> foi empossado nesta sexta-feira como novo presidente do Federal Reserve, substituindo Jerome Powell, cujo mandato se encerrou em 15 de maio.
                </p>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#f8fafc; border:1px solid #e2e8f0; border-radius:10px; margin:0 0 8px 0;">
                  <tr><td style="padding:8px 10px 4px 10px; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">— Pressão adicional sobre os rendimentos dos Treasuries, que testaram máximas de décadas</td></tr>
                  <tr><td style="padding:2px 10px 8px 10px; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">— Rotação de fluxo internacional de países emergentes para ativos americanos de tech e IA</td></tr>
                </table>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Na Europa, o PMI composto da zona do euro caiu de <strong>48,8</strong> para <strong>47,5</strong> em maio — o menor nível desde outubro de 2023 —, combinando enfraquecimento da atividade com custos ainda pressionados pelo conflito no Irã.
                </p>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  No Brasil, a semana trouxe dados que confirmam uma economia mais forte no início do ano. O IBC-Br aponta crescimento de <strong>1,3%</strong> no 1º trimestre de 2026, e a XP estima que o PIB avançou <strong>1,1%</strong> no período frente ao trimestre anterior — resultado acima das projeções de três meses atrás.
                </p>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Do lado fiscal, a arrecadação federal de abril superou expectativas com <strong>R$ 278,8 bilhões</strong> e alta real de <strong>7,8%</strong>. O segundo relatório bimestral trouxe bloqueio de despesas de <strong>R$ 22,1 bilhões</strong>, acima do esperado, concentrado em BPC/LOAS e benefícios previdenciários. A XP projeta déficit primário de <strong>0,4%</strong> do PIB em 2026 e não vê necessidade de novos bloqueios ao longo do ano.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  No entanto, a pressão inflacionária vinda do petróleo levou a XP a revisar a projeção de Selic para <strong>13,75%</strong> no final do ano.
                </p>
              </td>
            </tr>
                  ...
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <p style="margin:0 0 12px 0; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">
                        <strong>Principais indicadores da semana (19–22/mai):</strong>
                      </p>
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#0a1628; font-family:Arial, sans-serif;">−0,82% a 176.210 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#0a1628; font-family:Arial, sans-serif;">−0,12% a 7.477 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#0a1628; font-family:Arial, sans-serif;">+0,40% a R$ 5,01</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                      </table>
                      <p style="margin:0 0 8px 0; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">
                        A curva de juros abriu nos vértices mais longos, acompanhando o movimento dos Treasuries americanos.
                      </p>
                      <p style="margin:0; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">
                        A rotação global do fluxo estrangeiro em direção a tech e IA — favorecendo bolsas americanas e emergentes asiáticos como Taiwan e Coreia — segue pesando fortemente sobre a B3. Em abril, o fluxo estrangeiro no mercado à vista foi de apenas <strong>R$ 3,2 bilhões</strong> positivo, mas maio já acumula saída de <strong>R$ 3,6 bilhões</strong> no caixa. No acumulado do ano, o saldo ainda é positivo em <strong>R$ 53,5 bilhões</strong> — mas a reversão de tendência recente é um sinal de atenção para o mercado doméstico.
                      </p>
                    </td>
                  </tr>
                </table>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#0a1628; border-radius:14px;">
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>PIB do 1º trimestre de 2026 pelo IBGE (sexta-feira)</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>IPCA-15 de maio</strong> — expectativa de alívio em combustíveis, mas alta em alimentos e serviços</td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Core PCE de abril nos EUA</strong> — termômetro da inflação para o Fed</td></tr>
                        <tr><td style="padding:2px 0 8px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Caged e PNAD Contínua de abril</strong> — mercado de trabalho brasileiro</td></tr>
                      </table>
                      <p style="margin:0; font-size:13px; line-height:1.65; color:#edf2f7; font-family:Arial, sans-serif;">
