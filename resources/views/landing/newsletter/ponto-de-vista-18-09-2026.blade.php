...
<head>
  ...
  <title>Ponto de Vista - Semana de 14 a 18 de setembro de 2026</title>
  <meta name="description" content="Ponto de Vista: a leitura da Alta Vista sobre os mercados, por Guilherme Jung, economista-chefe. Semana de 14 a 18 de setembro de 2026.">
  <meta property="og:type" content="article">
  <meta property="og:locale" content="pt_BR">
  <meta property="og:title" content="Ponto de Vista - Semana de 14 a 18 de setembro de 2026">
  ...
  <meta name="twitter:title" content="Ponto de Vista - Semana de 14 a 18 de setembro de 2026">
          ...
          <table role="presentation" class="newsletter-card" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px; width:100%; background-color:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 10px 30px rgba(10,22,40,0.10);">
                  ...
                  <tr>
                    <td align="center" class="pad-page" style="padding:8px 30px 0 30px; text-align:center;">
                      ...
                      <p style="margin:2px 0 0 0; font-size:13px; line-height:1.7; color:#f7fafc; font-family:Arial, sans-serif; text-align:center;">
                        <strong>Semana de 14 a 18 de setembro de 2026</strong>
                      </p>
                    </td>
                  </tr>
                  <tr>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#0a1628; border-radius:14px;">
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <p style="margin:0 0 10px 0; font-size:13px; line-height:1.65; color:#edf2f7; font-family:Arial, sans-serif;">
                        O Fed subiu os juros para 3,75% a 4%, primeira alta desde 2023, enquanto o Copom cortou a Selic para 13,75%, sem sinalizar o próximo passo.
                      </p>
                      <p style="margin:0; font-size:13px; line-height:1.65; color:#edf2f7; font-family:Arial, sans-serif;">
                        O diferencial de juros entre Brasil e EUA ficou mais estreito: um colchão mais fino para o real, com eleição próxima e petróleo pressionado.
                      </p>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:4px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Nos Estados Unidos, o Fed reforçou que a inflação pesa mais que o emprego agora: são 60 meses de inflação acima da meta, com desemprego em 4,1% e mercado de trabalho resiliente.
                </p>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Isso tem dois efeitos claros:
                </p>
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 2px 0;">
                  <tr><td valign="top" style="padding:0 8px 6px 4px; font-size:13px; line-height:1.7; color:#c9a227; font-family:Arial, sans-serif; font-weight:bold;">&bull;</td><td style="padding:0 0 6px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">Juros altos por mais tempo, encarecendo o custo de capital global</td></tr>
                  <tr><td valign="top" style="padding:0 8px 6px 4px; font-size:13px; line-height:1.7; color:#c9a227; font-family:Arial, sans-serif; font-weight:bold;">&bull;</td><td style="padding:0 0 6px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">Menos espaço para cortes em emergentes, Brasil incluso</td></tr>
                </table>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Na Europa, o Banco da Inglaterra manteve a taxa em 3,75%.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Na Ásia, o Banco do Japão elevou a taxa em 25 pontos-base, para 1,25% a.a., o maior nível no país em 31 anos, e o Banco Popular da China decide juros já na segunda, 21/09 — sinal de que o aperto global segue no radar.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  No Brasil, a semana trouxe o corte de 0,25 p.p. na Selic, em linha com o esperado, sem sinalização clara para a frente. A leitura predominante é de mais dois cortes até o final do ano, condicionados ao comportamento da inflação, à desaceleração econômica e ao nível do petróleo.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  O fiscal segue preocupando: às vésperas da eleição, o governo promoveu um reajuste de benefícios sociais na casa dos R$ 22 bilhões e reacendeu o debate fiscal a poucas semanas do primeiro turno.
                </p>
              </td>
            </tr>
                  ...
                  <tr>
                    <td style="padding:16px 18px;">
                      <p style="margin:0 0 10px 0; font-size:15px; font-weight:bold; color:#0a1628; font-family:Arial, sans-serif;">
                        📈 Mercados — Fechamento semanal (18/09/2026)
                      </p>
                      <p style="margin:0 0 12px 0; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">
                        Cautela por aqui, apetite por risco lá fora: a semana fechou mista, com destaque para a disparada do bitcoin.
                      </p>
                      <p style="margin:0 0 12px 0; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#c53030; font-family:Arial, sans-serif;">&minus;1,06% aos 185,23 mil pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#276749; font-family:Arial, sans-serif;">+0,07% aos 7.670 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                <td class="mercado-ind-label" valign="middle" style="padding:12px 14px 12px 16px; font-size:12px; line-height:1.35; color:#718096; font-family:Arial, sans-serif; width:42%;">Nasdaq 100</td>
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#276749; font-family:Arial, sans-serif;">+1,12% aos 29.695 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#4a5568; font-family:Arial, sans-serif;">R$ 5,13, praticamente estável</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#276749; font-family:Arial, sans-serif;">+5,11% a US$ 81.179</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#276749; font-family:Arial, sans-serif;">+0,73% a US$ 4.379/oz</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Um mundo em aperto e um Brasil que corta juros testam o carrego, o câmbio e o prêmio fiscal ao mesmo tempo.
                </p>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Ciclos mudam. Políticas mudam. E os mercados se ajustam.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Disciplina, diversificação e horizonte longo valem mais do que reagir a cada manchete.
                </p>
              </td>
            </tr>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#0a1628; border-radius:14px;">
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Segunda (21/09): decisão de juros na China</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Terça (22/09): ata do Copom</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Quarta (23/09): PMIs preliminares nos EUA e na Europa</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Quinta (24/09): decisão de juros na Suíça</strong></td></tr>
                        <tr><td style="padding:6px 0 4px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">Com bancos centrais ainda divididos, cada dado pode redefinir o preço dos juros e do câmbio.</td></tr>
                      </table>
                    </td>
                  </tr>
                </table>
