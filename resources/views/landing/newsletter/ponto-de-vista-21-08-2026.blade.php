...
<head>
  ...
  <title>Ponto de Vista - Semana de 17 a 21 de agosto de 2026</title>
  <meta name="description" content="Ponto de Vista: a leitura da Alta Vista sobre os mercados, por Guilherme Jung, economista-chefe. Semana de 17 a 21 de agosto de 2026.">
  <meta property="og:type" content="article">
  <meta property="og:locale" content="pt_BR">
  <meta property="og:title" content="Ponto de Vista - Semana de 17 a 21 de agosto de 2026">
  ...
  <meta name="twitter:title" content="Ponto de Vista - Semana de 17 a 21 de agosto de 2026">
          ...
          <table role="presentation" class="newsletter-card" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px; width:100%; background-color:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 10px 30px rgba(10,22,40,0.10);">
                  ...
                  <tr>
                    <td align="center" class="pad-page" style="padding:8px 30px 0 30px; text-align:center;">
                      ...
                      <p style="margin:2px 0 0 0; font-size:13px; line-height:1.7; color:#f7fafc; font-family:Arial, sans-serif; text-align:center;">
                        <strong>Semana de 17 a 21 de agosto de 2026</strong>
                      </p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <p style="margin:0; font-size:13px; line-height:1.65; color:#edf2f7; font-family:Arial, sans-serif;">
                        US$ 40 tri. de dívida pública americana marcou novo recorde e foi o pano de fundo de toda a semana. O Tesouro dobrou as recompras de títulos de 10 a 30 anos para conter os juros longos — o mercado leu como insuficiente diante do tamanho da dívida. O alívio durou um dia: na semana, o Treasury de 30 anos superou 5,30%, maior patamar desde 2002. O Tesouro compra tempo, não resolve o problema estrutural. Bessent promete novas medidas já na segunda.
                      </p>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:4px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  A ata do Fed mostrou dirigentes divididos: 3 dos 9 membros votaram por alta de juros. O mercado já precifica alta de 25 p.b. até o fim do ano.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  O Brent subiu 7% na semana, a US$ 94, com Ormuz praticamente paralisado. Na China, produção industrial e varejo de julho decepcionaram, reforçando a desaceleração e a aposta em novos estímulos de Pequim.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  O IBC-Br de junho recuou 0,6% m/m, em linha com o esperado, confirmando desaceleração gradual no 2º trimestre (0,2% T/T). A XP mantém o PIB em 2,0% para 2026 e 1,0% para 2027, com viés de baixa.
                </p>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  No campo eleitoral, pesquisa CNN/Genial mostrou Flávio Bolsonaro levemente à frente de Lula pela 1ª vez, cenário de 2º turno apertado.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Trump liberou 300 mil ton. de carne bovina brasileira sem tarifa nos EUA, positivo para frigoríficos e exportações do agro.
                </p>
              </td>
            </tr>
                  ...
                  <tr>
                    <td style="padding:16px 18px;">
                      <p style="margin:0 0 10px 0; font-size:15px; font-weight:bold; color:#0a1628; font-family:Arial, sans-serif;">
                        📈 Mercados — Fechamento semanal (21/08/2026)
                      </p>
                      <p style="margin:0 0 12px 0; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">
                        A semana fechou com dispersão: ativos brasileiros e commodities em alta forte, bolsa americana perdendo terreno. Bitcoin subiu 24% e o ouro renovou máxima na semana, sinal de apetite por proteção com a pressão fiscal americana no radar.
                      </p>
                      <p style="margin:0 0 12px 0; font-size:13px; line-height:1.6; color:#4a5568; font-family:Arial, sans-serif;">
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#276749; font-family:Arial, sans-serif;">+2,45% a 171.030 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#c53030; font-family:Arial, sans-serif;">−1,44% a 7.677 pts</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                          ...
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                ...
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#276749; font-family:Arial, sans-serif;">−0,8% a R$ 5,13</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                        <tr>
                          <td style="padding:0 0 8px 0;">
                            <table role="presentation" class="mercado-indicator-row" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff; border:1px solid #e2e8f0; border-radius:12px;">
                              <tr>
                                <td class="mercado-ind-label" valign="middle" style="padding:12px 14px 12px 16px; font-size:12px; line-height:1.35; color:#718096; font-family:Arial, sans-serif; width:42%;">Curva de juros (DI jan/29 e jan/31)</td>
                                <td class="mercado-ind-value" valign="middle" align="right" style="padding:12px 16px 12px 10px; font-size:15px; line-height:1.35; font-weight:bold; color:#c53030; font-family:Arial, sans-serif;">+9 p.b. e +19 p.b.</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 16px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Mercados são cíclicos por natureza. A semana mostrou como intervenções pontuais aliviam sintomas, mas não mudam o diagnóstico: dívida alta e juros seguem o pano de fundo global. O Brasil navega bem esse cenário, por ora.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Ciclos mudam. Políticas mudam. E os mercados se ajustam. Disciplina e diversificação separam quem atravessa a volatilidade de quem é atravessado por ela.
                </p>
              </td>
            </tr>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#0a1628; border-radius:14px;">
                  <tr>
                    <td style="padding:16px 18px;">
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Segunda: Boletim Focus e novas medidas de Bessent sobre o Irã</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Quarta: IPCA-15 e PCE nos EUA</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Quinta a sábado: Jackson Hole, com Warsh discursando na sexta</strong></td></tr>
                        <tr><td style="padding:2px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">* <strong>Sexta: CAGED, PNAD Contínua e revisão anual do payroll americano</strong></td></tr>
                        <tr><td style="padding:2px 0 8px 0; font-size:13px; line-height:1.6; color:#edf2f7; font-family:Arial, sans-serif;">Jackson Hole é o evento a observar: qualquer sinal de Warsh sobre juros deve mexer a curva.</td></tr>
                      </table>
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td align="left" class="pad-page" style="padding:2px 30px 10px 30px;">
                ...
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Em um cenário mais complexo, interpretar dados e transformar informação em estratégia faz diferença.
                </p>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Na Alta Vista, acompanhamos o cenário global e doméstico diariamente para ajudar nossos clientes a construir e preservar patrimônio com visão de longo prazo.
                </p>
                <p style="margin:0 0 8px 0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
                  Se deseja investir com estratégia e uma equipe dedicada, fale com um de nossos assessores.
                </p>
                <p style="margin:0; font-size:13px; line-height:1.7; color:#4a5568; font-family:Arial, sans-serif;">
