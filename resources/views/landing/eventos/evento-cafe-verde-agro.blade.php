...
<head>
    ...
    <meta name="description" content="Café da manhã com a Verde Agro & Imobiliário - Evento presencial em São Paulo. 19/03/2026 com Luis Stuhlberger e Gustavo Campos.">
    <title>Café da manhã com a Verde Agro & Imobiliário | Alta Vista Investimentos</title>
...
<body>
    <section class="hero-section container">
        <div class="hero-header">
            ...
            <div class="event-badge">Evento presencial</div>
            <h1>Café da manhã com a <span class="accent">Verde Agro & Imobiliário</span></h1>
            <p>Participe deste encontro exclusivo em São Paulo com <strong>Luis Stuhlberger</strong> (Gestor da Estratégia Verde) e <strong>Gustavo Campos</strong> (CGE - Gestor e Head de Originação e Estruturação). Welcome coffee e palestra.</p>
            <div class="event-info">
                <div class="event-info-item">
                    <i class="bi bi-calendar-event"></i>
                    <span class="label">Data</span>
                    <span class="value">19/03/2026<small>quinta-feira</small></span>
                </div>
                <div class="event-info-item">
                    <i class="bi bi-clock"></i>
                    <span class="label">Horário</span>
                    <span class="value">08h30 Welcome coffee<small>09h00 Palestra</small></span>
                </div>
                <div class="event-info-item">
                    <i class="bi bi-geo-alt"></i>
                    <span class="label">Local</span>
                    <span class="value" style="font-size:0.95rem;">Av. Brig. Faria Lima, N° 3600<br>11º andar - CJ 111<br>Itaim Bibi - São Paulo - SP</span>
                </div>
            </div>
        </div>
        <div class="event-banner">
            <img src="/img/evento-cafe-verde-agro-convite.png" alt="Convite - Café da manhã com a Verde Agro & Imobiliário">
        </div>
    </section>
    ...
    <section class="container">
        <div class="about-section">
            ...
            <p>
                Convidamos você para um café da manhã com a <strong>Verde Agro & Imobiliário</strong>. O evento conta com <strong>Luis Stuhlberger</strong> (Gestor da Estratégia Verde) e <strong>Gustavo Campos</strong> (CGE - Gestor e Head de Originação e Estruturação). Às 08h30 servimos um welcome coffee; às 09h00 começa a palestra. O endereço é Av. Brig. Faria Lima, N° 3600, 11º andar - CJ 111, Itaim Bibi - São Paulo - SP. <strong>Confirme sua presença preenchendo o formulário abaixo.</strong> Esperamos você.
            </p>
        </div>
    </section>
    ...
    <section class="container">
        <div class="lead-section">
            ...
            <p class="form-intro">Preencha o formulário abaixo para confirmar sua participação no café da manhã. Você receberá uma confirmação por e-mail.</p>
