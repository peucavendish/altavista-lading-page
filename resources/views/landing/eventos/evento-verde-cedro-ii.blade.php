...
<head>
    ...
    <meta name="description" content="Live online sobre o fundo Verde Cedro II, alternativa de renda fixa atrelada ao CDI com expectativa de retorno de CDI + 2,30% líquido de impostos.">
    <title>Live | Fundo Verde Cedro II | Alta Vista Investimentos</title>
    ...
    <style>
        ...
        * {
        ...
        .event-info-item .value.placeholder {
            opacity: 0.9;
        }
...
<body>
    ...
    <section class="hero-section container">
        <div class="hero-header">
            ...
            <h1>Live sobre o fundo <span class="accent">Verde Cedro II</span></h1>
            <p>Participe desta live exclusiva e entenda o cenário, as características do fundo e como ele pode reforçar a parcela de renda fixa da sua carteira. Abertura com o gestor Luiz Parreiras e espaço para dúvidas.</p>
            <div class="event-info">
                <div class="event-info-item">
                    <i class="bi bi-calendar-event"></i>
                    <span class="label">Data</span>
                    <span class="value">18/03/2026<br><span style="font-size:0.9rem; font-weight:500;">quarta-feira</span></span>
                </div>
                <div class="event-info-item">
        ...
        <div class="event-banner">
            <img src="/img/evento-verde-cedro-ii-convite.png" alt="Convite - Live com a Verde Agro & Imobiliário">
        </div>
    </section>
    ...
    <section class="container">
        <div class="about-section">
            ...
            <p>
                Quero te convidar para uma live online sobre o fundo Verde Cedro II. A abertura será feita pelo gestor <strong>Luiz Parreiras</strong>, que vai trazer uma visão de cenário. Na sequência, vamos falar sobre o fundo: uma alternativa de renda fixa atrelada ao CDI, com expectativa de retorno de <strong>CDI + 2,30%</strong>, livre de impostos. A ideia é apresentar os principais pontos do produto, seus diferenciais e também abrir espaço para dúvidas. <strong>O link de acesso será enviado por e-mail após a sua inscrição.</strong> Espero você.
            </p>
        </div>
    </section>
    ...
    <section class="container">
        <div class="lead-section">
            ...
            <p class="form-intro">Preencha o formulário abaixo para garantir sua participação na live. O link de acesso será enviado por email.</p>
