...
<head>
    ...
    <title>Inscrição Confirmada - Live Verde Cedro II | Alta Vista Investimentos</title>
...
<body>
    <div class="container">
        <div class="thank-you-container">
            <img src="/img/ASSINATURA-HORIZONTAIS-LIGHT-XP.png" alt="Alta Vista Logo" class="mb-4" style="max-width:300px; width:100%">
            ...
            <p class="description">
                Sua inscrição na live sobre o fundo <strong>Verde Cedro II</strong> foi confirmada. Use o link abaixo para acessar a transmissão.
            </p>

            <div class="event-banner-thank">
                <img src="/img/evento-verde-cedro-ii-convite.png" alt="Live com a Verde Agro & Imobiliário">
            </div>
            ...
            <div class="event-details">
                ...
                <div class="event-details-item">
                    ...
                    <span><strong>Data:</strong> 18/03/2026 (quarta-feira)</span>
                </div>
                <div class="event-details-item">
                    <i class="bi bi-clock"></i>
                    <span><strong>Horário:</strong> 18h00</span>
                </div>
                <div class="event-details-item">
                    <i class="bi bi-camera-video"></i>
                    <span><strong>Formato:</strong> Online ao vivo</span>
                </div>
            </div>
            ...
            <div class="live-link-box">
                ...
                <a href="https://youtube.com/live/My8K2er6X8A?feature=share" target="_blank" rel="noopener noreferrer" class="btn-live">
