...
<head>
    ...
    <title>Parceria Alta Vista & NQ Contábil | Investimentos</title>
...
<body>
        ...
        <div class="col-12 hero-left">
            <div class="hero-content-inspire">
                <div class="logos-container">
                    ...
                    <div class="logo-item">
                        <img src="/img/nqcontabil.png" alt="NQ Contábil Logo" style="max-height:100px; width:auto; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.3));">
                    </div>
                </div>
                <div class="partnership-badge">🤝 Parceria Estratégica</div>
                <h1>Cadastro de <span>Leads</span></h1>
                <p class="mb-0">Ferramenta exclusiva para profissionais da NQ Contábil cadastrarem leads interessados em serviços da Alta Vista Investimentos.</p>
            </div>
        </div>
    </section>
    ...
    <section class="container">
        <div class="info-box">
            ...
            <p>
                Esta página foi desenvolvida exclusivamente para os profissionais da <strong>NQ Contábil</strong> cadastrarem leads interessados em serviços de assessoria de investimentos da <strong>Alta Vista Investimentos</strong>. 
    ...
    <section class="container">
        <div class="lead-section">
            ...
            <!-- HubSpot Form -->
            <div class="hs-form-frame" data-region="na1" data-form-id="6bb0f0b8-b972-4e29-9c18-73ea40450ddd" data-portal-id="21698044"></div>
        </div>
    </section>
