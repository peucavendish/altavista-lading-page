...
<head>
    ...
    <title>Inscrição Confirmada - Webinar IRPFM | Alta Vista Investimentos</title>
...
<body>
    <div class="container">
        <div class="thank-you-container">
            ...
            <p class="description">
                Parabéns! Sua inscrição no <strong>Webinar sobre IRPFM</strong> foi confirmada com sucesso.
            </p>
            ...
            <p class="description">
                O link de acesso ao webinar será enviado para o email cadastrado alguns dias antes do evento. 
            ...
            <div class="info-box">
                <p>
                    ...
                    <strong>Importante:</strong> Caso não receba o email com o link de acesso, entre em contato conosco através do seu assessor de investimentos.
                </p>
            </div>
        </div>
    </div>
