...
<head>
    ...
    <meta name="description" content="Você ganhou o curso Inteligência em Investimentos — Alta Vista Investimentos.">
...
<body>
            ...
            <div class="hero-content-inspire">
                ...
                <div class="trust-bar">
                    <div class="trust-logos">
                        <img src="/img/ASSINATURA-HORIZONTAIS-LIGHT-XP.png" alt="Alta Vista Investimentos" class="logo-av" width="280" height="65">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="lead-section">
        <div class="container-fluid px-0">
            ...
            <div id="hubspot-form-inteligencia-investimentos" class="hubspot-form-wrap"></div>
        </div>
    </section>
    ...
    <script type="text/javascript">
        hbspt.forms.create({
            ...
            target: '#hubspot-form-inteligencia-investimentos',
            onFormSubmitted: function () {
                window.location.href = @json(url('/inteligencia-investimentos/obrigado'));
            }
        });
    </script>
</body>
