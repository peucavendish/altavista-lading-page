...
<head>
    ...
    <meta name="description" content="Obrigado pelo seu interesse em analisar sua previdência com a Alta Vista.">
    ...
    fbq('init', '1350252973614837');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1350252973614837&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
...
<body>
    <main class="thank-card">
        ...
        <p class="lead">
            Obrigado pelo interesse em analisar sua previdência com a Alta Vista.
            Nosso time vai avaliar suas informações e entrar em contato em breve.
        </p>

        <div class="action-row">
            <a href="/previdencia-portabilidade" class="btn-main">
        ...
        <div class="info">
            <strong>Próximo passo:</strong> no primeiro contato, vamos analisar sua previdência atual — taxas, fundos e estrutura — e apresentar alternativas alinhadas aos seus objetivos, incluindo as opções de benefício na portabilidade para a XP.
        </div>
    </main>
</body>
</html>
