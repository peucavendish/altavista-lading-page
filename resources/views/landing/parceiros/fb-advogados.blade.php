...
<head>
    ...
    <title>Parceria Alta Vista & FB Advogados | Investimentos</title>
...
<body>
        ...
        <div class="col-12 hero-left">
            <div class="hero-content-inspire">
                <div class="logos-container">
                    ...
                    <div class="logo-item">
                        <div class="partner-name-badge" role="img" aria-label="FB Advogados">FB Advogados</div>
                    </div>
                </div>
                <div class="partnership-badge">🤝 Parceria Estratégica</div>
                <h1>Cadastro de <span>Leads</span></h1>
                <p class="mb-0">Ferramenta exclusiva para o parceiro FB Advogados cadastrar leads interessados em serviços da Alta Vista Investimentos.</p>
            </div>
        </div>
    </section>
    ...
    <section class="container">
        <div class="info-box">
            ...
            <p>
                Esta página foi desenvolvida exclusivamente para o parceiro <strong>FB Advogados</strong> cadastrar leads interessados em serviços de assessoria de investimentos da <strong>Alta Vista Investimentos</strong>. 
    ...
    <section class="container">
        <div class="lead-section">
            ...
            <!-- HubSpot Form -->
            <div class="hs-form-frame" data-region="na1" data-form-id="ff2c4922-7210-4ab6-84d4-e166d7d95d01" data-portal-id="21698044"></div>
        </div>
    </section>
