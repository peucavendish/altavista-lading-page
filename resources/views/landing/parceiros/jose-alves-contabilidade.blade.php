...
<head>
    ...
    <title>Parceria Alta Vista & José Alves Contabilidade | Investimentos</title>
    ...
    <style>
        ...
        * {
        ...
        .partner-name-badge {
            ...
            border: 1.5px solid rgba(255, 201, 113, 0.55);
            border-radius: 12px;
            background: rgba(0, 24, 69, 0.35);
            text-shadow: 0 2px 10px rgba(0, 24, 69, 0.4);
        }
...
<body>
        ...
        <div class="col-12 hero-left">
            <div class="hero-content-inspire">
                <div class="logos-container">
                    ...
                    <div class="logo-item">
                        <div class="partner-name-badge" role="img" aria-label="José Alves Contabilidade">José Alves Contabilidade</div>
                    </div>
                </div>
                <div class="partnership-badge">🤝 Parceria Estratégica</div>
                <h1>Cadastro de <span>Leads</span></h1>
                <p class="mb-0">Ferramenta exclusiva para profissionais da José Alves Contabilidade cadastrarem leads interessados em serviços da Alta Vista Investimentos.</p>
            </div>
        </div>
    </section>
    ...
    <section class="container">
        <div class="info-box">
            ...
            <p>
                Esta página foi desenvolvida exclusivamente para os profissionais da <strong>José Alves Contabilidade</strong> cadastrarem leads interessados em serviços de assessoria de investimentos da <strong>Alta Vista Investimentos</strong>. 
    ...
    <section class="container">
        <div class="lead-section">
            ...
            <!-- HubSpot Form -->
            <div class="hs-form-frame" data-region="na1" data-form-id="69735580-56b9-4820-ac6e-ad42b8046a66" data-portal-id="21698044"></div>
        </div>
    </section>
