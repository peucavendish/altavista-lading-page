...
<head>
    ...
    <title>Parceria Alta Vista & Egon Henrique Muniz Cardoso | Investimentos</title>
...
<body>
        ...
        <div class="col-12 hero-left">
            <div class="hero-content-inspire">
                <div class="logos-container">
                    ...
                    <div class="logo-item">
                        <div class="partner-name-badge" role="img" aria-label="Egon Henrique Muniz Cardoso">Egon Henrique Muniz Cardoso</div>
                    </div>
                </div>
                <div class="partnership-badge">🤝 Parceria Estratégica</div>
                <h1>Cadastro de <span>Leads</span></h1>
                <p class="mb-0">Ferramenta exclusiva para o parceiro Egon Henrique Muniz Cardoso cadastrar leads interessados em serviços da Alta Vista Investimentos.</p>
            </div>
        </div>
    </section>
    ...
    <section class="container">
        <div class="info-box">
            ...
            <p>
                Esta página foi desenvolvida exclusivamente para o parceiro <strong>Egon Henrique Muniz Cardoso</strong> cadastrar leads interessados em serviços de assessoria de investimentos da <strong>Alta Vista Investimentos</strong>. 
