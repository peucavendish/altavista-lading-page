...
<head>
    ...
    <title>Parceria Alta Vista & AWS Audit | Investimentos</title>
    ...
    <style>
        ...
        * {
        ...
        .hero-left::before { 
            ...
            position: absolute; 
            inset: 0; 
            background: linear-gradient(135deg, rgba(0,24,69,0.78) 0%, rgba(0,24,69,0.58) 50%, rgba(0,24,69,0.42) 100%); 
        }
...
<body>
        ...
        <div class="col-12 hero-left">
            <div class="hero-content-inspire">
                <div class="logos-container">
                    ...
                    <div class="logo-item partner-logo">
                        <img src="/img/aws-audit.png" alt="AWS Audit & Consult Logo">
                    </div>
                </div>
                <div class="partnership-badge">🤝 Parceria Estratégica</div>
                <h1>Cadastro de <span>Leads</span></h1>
                <p class="mb-0">Ferramenta exclusiva para profissionais da AWS Audit & Consult cadastrarem leads interessados em serviços da Alta Vista Investimentos.</p>
            </div>
        </div>
    </section>
    ...
    <section class="container">
        <div class="info-box">
            ...
            <p>
                Esta página foi desenvolvida exclusivamente para os profissionais da <strong>AWS Audit & Consult</strong> cadastrarem leads interessados em serviços de assessoria de investimentos da <strong>Alta Vista Investimentos</strong>. 
    ...
    <section class="container">
        <div class="lead-section">
            ...
            <p class="text-center mb-4" style="color:#4a5568; font-size:1.05rem;">Preencha os dados do lead interessado nos serviços de assessoria de investimentos da Alta Vista. Os dados serão enviados para a empresa parceira que entrará em contato.</p>
            
            <!-- HubSpot Form -->
            <div class="hs-form-frame" data-region="na1" data-form-id="313239a1-1d2d-4334-8f28-547460981d7e" data-portal-id="21698044"></div>
        </div>
    </section>
